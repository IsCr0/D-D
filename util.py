...
dotes_con_guiones = ['"' + dote.strip() + '",' for dote in dotes]

# Imprimir la lista de dotes con guiones
#for dote in dotes_con_guiones:
#    print(dote)
    
with open("DotesLimpios.txt", "w") as archivo:
    for dote in dotes_con_guiones:
        archivo.write(dote + "\n")
        print(dote)